<div class="flash-data" data-flashdata="<?= $this->session->flashdata('message'); ?>"></div>
    ...
    <div class="container-fluid">
        ...
        <?php echo form_open_multipart('user/kematian'); ?>
                <br>
          ...
          <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Meninggal pada</label>
                            <input type="date" class="form-control form-control-sm" name="tgl_mgl" value="<?php echo date('Y/m/d'); ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                         <label>Nama Pelapor</label>
                            <input type="text" class="form-control form-control-sm" name="nama_pelapor" value="<?php echo $user['nama']; ?>" required>
                    </div>
                </div>
        </div>
        <div class="row">
        <div class="col-md-6">
                <div class="form-group">
                         ...
                         <input type="text" class="form-control form-control-sm" name="nik_pelapor" pattern="[0-9]+" required>
                    </div>
                </div>

                <div class="col-md-6">
                <div class="form-group">
                            <label for="hub">Hubungan pelapor dengan yang alm.</label>
                             <select class="form-control form-control-sm" name="hub" required>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Surat keterangan dari rumah sakit</label>
