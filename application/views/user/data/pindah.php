<div class="flash-data" data-flashdata="<?= $this->session->flashdata('message'); ?>"></div>
    ...
    <div class="container-fluid">
        ...
        <?php echo form_open_multipart('user/pindah'); ?>
                <br>
          ...
          <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-sm" name="alamat_tujuan" required ></textarea>
                </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>foto 4x6 Background Merah</label>
                            <input type="file" class="form-control-file" name="lampiran2" >
                    </div>
                </div>
