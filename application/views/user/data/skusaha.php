<div class="flash-data" data-flashdata="<?= $this->session->flashdata('message'); ?>"></div>
    ...
    <div class="container-fluid">
        ...
        <?php echo form_open_multipart('user/skusaha'); ?>
                <br>
          ...
          <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4">
                     <div class="form-group">
                        <label>Upload Scan KTP/KK</label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Surat pernyataan Bermaterai 10.000</label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Lampiran tambahan</label>
                            <input type="file" class="form-control-file" name="lampiran4" >
                    </div>
                </div>
