                                   ...
                                   <?php foreach ($dokumen_saya as $lu) : ?>
                                    <?php if ($lu['status_db_dokumen'] == 1) : ?>
                                       <tr>
                                           ...
                                           <?php endif; ?>
                                           <?php if ($lu['status_db_dokumen'] == 1) : ?>
                                               <td><a href="<?php echo base_url('user/del_dokumen/' . $lu['id_db_dokumen']); ?>" class="tombol-hapus btn btn-danger btn-block btn-sm"><i class="fas fa-trash-alt"></i> Hapus</a></td>
                                           <?php elseif ($lu['status_db_dokumen'] == 0) : ?>
