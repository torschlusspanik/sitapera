           ...
           <div class="col-xl-12 col-lg-5">
               <div class="card shadow mb-4">
                   <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                       <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-user"><i class="fas fa-envelope"></i> <b>Tambah Dokumen</b></button>
                   </div>
                   <div class="card-body">
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="box-body">
                       <form action="<?php echo base_url('admin/mst_dokumen'); ?>" method="post">
                           <div class="form-group">
                               <label>Nama Dokumen</label>
                               <input type="text" class="form-control form-control-sm" name="nama_dokumen" required>
                               <label>Persyaratan</label>
                               <input type="text" class="form-control form-control-sm" name="persyaratan" required>
                           </div>
   ...
   <div class="modal fade" id="detail-warga">
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <div class="box-body">
                       <form action="<?php echo base_url('admin/edit_dokumen'); ?>" method="post">
                           <div class="form-group">
                               <label>Nama Dokumen</label>
